...
Authentication error. Used when [HTTP Basic Authentication](https://blog.yexca.net/en/archives/64/#http-basic-authentication) is required but the *Authorization* header is missing or invalid.
...
*   [“Graphing HTTP” Summary - yexca'Blog](https://blog.yexca.net/en/archives/29)
