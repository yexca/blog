...
I followed the guide [Setting Static IP in a Virtual Machine (CentOS Example)](https://blog.yexca.net/en/archives/39) to get the VM online. For file modification, I just needed to change `ONBOOT` to `yes` and add two DNS entries.
...
Then, the "Boxes" software seemed to support direct drag-and-drop. I downloaded the file on my main computer and dragged it over. It failed. The file wasn't transferred. Considering the target location was `~/Downloads/` and I was using the root account, I followed [Adding Users and Administrator Users in Linux](https://blog.yexca.net/en/archives/41) to create a new user. (I almost ran the step to delete the user.)
...
[Setting Static IP in a Virtual Machine (CentOS Example) - yexca'Blog](https://blog.yexca.net/en/archives/39)

[Installing Git - Leo Xuefeng's Official Website](https://www.liaoxuefeng.com/wiki/896043488029600/896067074338496)

[Adding Users and Administrator Users in Linux - yexca'Blog](https://blog.yexca.net/en/archives/41)
