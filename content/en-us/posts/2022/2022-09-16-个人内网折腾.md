...
Picking up where we left off [last time](https://blog.yexca.net/archives/71), let's keep tinkering.
...
*Note: Deployed using Docker Desktop. Since the process is almost identical to [last time](https://blog.yexca.net/archives/71), I won't repeat the deployment steps.*
