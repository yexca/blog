...
> Reference: [Server Docker Deployment Record](https://blog.yexca.net/archives/102)

## Public Key Login

Reference: [SSH Public Key Login](https://blog.yexca.net/archives/70)
...
A big reason for the impulse buy was wanting a decent music site for personal use. I previously had one [based on OneDrive](https://blog.yexca.net/archives/105), but the experience in mainland China was poor. Since 115 was having a promotion, I went for it.
