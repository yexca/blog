...
I'm using Hugo via Docker, so I didn't have to mess with local environment issues. You can see [my setup here](https://blog.yexca.net/en/archives/182/#blog).
...
> Font Internationalization: <https://blog.yexca.net/en/archives/240>
