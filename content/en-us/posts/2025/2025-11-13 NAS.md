...
Back in 2022, when I was first messing with Linux, I had this idea that you don't necessarily have to pay for a special OS just to build a NAS.
...
(See: 2025 New Server Setup Log#Installing-nginx-ui for why I set that environment variable).
