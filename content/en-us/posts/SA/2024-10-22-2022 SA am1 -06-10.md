...
Yeah, these are just database normal forms (though 'regular form' sounds a bit off). I even [wrote a post about them](https://blog.yexca.net/archives/90). Checking the [summary section](https://blog.yexca.net/archives/90#%E8%8C%83%E5%BC%8F%E6%80%BB%E7%BB%93), 1NF maps to c, 2NF to a, and 3NF to b. So, option C it is.
