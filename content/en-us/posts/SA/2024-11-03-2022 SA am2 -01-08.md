...
I looked up some [related info](https://www.digitalocean.com/community/tutorials/gangs-of-four-gof-design-patterns), and it seems this is where the [design patterns I wrote about previously](https://blog.yexca.net/archives/140) originated.
...
The diagram shows the Strategy pattern implemented for multi-format report generation. The core principle is separating the implementation of an algorithm from its use, allowing you to switch or add algorithms without touching the client code. I've actually [written about Strategy pattern before](https://blog.yexca.net/archives/137).
...
This is about software coupling. I've also [written an article on this](https://blog.yexca.net/archives/145#%E8%80%A6%E5%90%88).
