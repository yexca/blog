...
遡ること[2022年、僕がLinuxをいじっていた頃(中国語簡体字)](/archives/73/)、NASを構築するのに必ずしも専用システムにお金を払う必要はない、という話をした。
...
- 2025-10-05: [漫画と音声サイト構築](/archives/258/)
- 2023-05-02: [個人用音楽サイトの構築](/archives/105/)
- 2022-09-16: [プライベートネットワーク構築記](/archives/73/)
- 2022-09-14: [FedoraにKomgaをインストールした記録](/archives/71/)
...
（なぜ環境変数を設定するのかは、[2025 新サーバー構築記録#Nginx-UIのインストール(中国語簡体字)](/archives/257/#安装-nginx-ui) を参照）
