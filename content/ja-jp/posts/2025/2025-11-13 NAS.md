...
遡ること[2022年、僕がLinuxをいじっていた頃(中国語簡体字)](/ja/archives/73/)、NASを構築するのに必ずしも専用システムにお金を払う必要はない、という話をした。
...
次にインストール方法。[WEPE](https://www.wepe.com.cn/)との互換性を考慮し、[Ventoy](https://www.ventoy.net/)をメインブートにしてシステムをインストールする。

サービスのデプロイはDockerを使い、ホストOSのクリーンさと再現性を担保する。

**使用するサービス：**

- **動画:** [Emby](https://emby.media/)
- **漫画:** [Komga](https://komga.org/)
- **音楽:** [Navidrome](https://hub.docker.com/r/deluan/navidrome)
- **音声:** [Kikoeru](https://github.com/Number178/kikoeru-express)
- **共有:** [Samba](https://github.com/crazy-max/docker-samba/pkgs/container/samba)
- **統一ポータル:** [Heimdall](https://hub.docker.com/r/linuxserver/heimdall)

**検討したけど使わなかったサービス：**

- **動画:** [Jellyfin](https://jellyfin.org/)
- **漫画/小説:** [Kavita](https://www.kavitareader.com/)
- **クラウドマウント:** [CloudDrive](https://www.clouddrive2.com/index.html)
...
[公式サイトでAlpine Linuxをダウンロード](https://www.alpinelinux.org/downloads/)し、VentoyをインストールしたUSBメモリに入れる。マザーボードのBIOSでUSBメモリから起動するよう設定し、Ventoyの画面でAlpine Linuxを選んで起動する。
...
公式ドキュメント: [setup-alpine - Alpine Linux](https://docs.alpinelinux.org/user-handbook/0.1a/Installing/setup_alpine.html)
...
- 2025-10-05: [漫画と音声サイト構築](/ja/archives/258/)
- 2023-05-02: [個人用音楽サイトの構築](/ja/archives/105/)
- 2022-09-16: [プライベートネットワーク構築記](/ja/archives/73/)
- 2022-09-14: [FedoraにKomgaをインストールした記録](/ja/archives/71/)
...
（なぜ環境変数を設定するのかは、[2025 新サーバー構築記録#Nginx-UIのインストール(中国語簡体字)](/ja/archives/257#nginx-ui-のインストール) を参照）
