...
在 conda 对应环境内，运行如下命令找到 YOLO 安装位置

```bash
python -c "import ultralytics.nn.tasks as t; print(t.__file__)"
```

但是此方法在更新库后将会失效，可以将官方源码下载到本地

下载地址：[ultralytics/ultralytics](https://github.com/ultralytics/ultralytics)

然后在项目根目录内，使用 pip 本地加载库
