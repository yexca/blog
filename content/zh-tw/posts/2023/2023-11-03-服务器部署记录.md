...
> 此部分參考：[伺服器用 Docker 部署紀錄](https://blog.yexca.net/zh-tw/archives/102)

## 公鑰登入

參考：[SSH 公鑰登入](https://blog.yexca.net/zh-tw/archives/70)
...
衝動消費的一個主要原因還有想搞一個還行的音樂網站自用，之前有一個[基於 OneDrive 的](https://blog.yexca.net/zh-tw/archives/105)，但在中國大陸訪問體驗不好，又恰逢 115 出活動，所以有了這篇文章。
