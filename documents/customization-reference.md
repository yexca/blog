...
- category cards link to their term pages
- the category index shows preview panels for the first three categories
- each preview panel is capped at six posts
- full category browsing uses the term page and Hugo pagination
...
The macOS-style window dots are generated by `assets/ts/features/codeBlocks.ts`.
...
Twikoo has additional custom CSS in `partials/comments/twikoo.scss`.
The Twikoo provider template should stay markup-only and expose configuration
through `data-*` attributes.

## Shortcode Styling

Shortcode templates stay focused on markup. Shared shortcode styling is in:

```text
themes/hugo-theme-stack/assets/scss/partials/components/shortcodes.scss
```
...
The `details.html` shortcode outputs `class="stack-shortcode-details"`, so its
styles are scoped and do not affect native `details` elements elsewhere.
...
themes/hugo-theme-stack/assets/scss/partials/sidebar.scss
themes/hugo-theme-stack/assets/scss/partials/layout/archives.scss
themes/hugo-theme-stack/assets/scss/partials/layout/about.scss
themes/hugo-theme-stack/assets/scss/partials/components/github-info-card.scss
themes/hugo-theme-stack/assets/scss/partials/components/shortcodes.scss
themes/hugo-theme-stack/assets/scss/custom.scss
themes/hugo-theme-stack/assets/ts/core/pageInit.ts
themes/hugo-theme-stack/assets/ts/features
```
